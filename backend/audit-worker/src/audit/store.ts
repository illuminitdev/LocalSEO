  ...
  return {
    ...
    gbpLookup: audit.gbpLookup
      ? {
          ...
          reviewReplyRate: (audit.gbpLookup as Record<string, unknown>).reviewReplyRate ?? null,
          ...
          hasServices: (audit.gbpLookup as Record<string, unknown>).hasServices ?? null,
          hasProducts: (audit.gbpLookup as Record<string, unknown>).hasProducts ?? null,
          hasSecondaryCategories:
            (audit.gbpLookup as Record<string, unknown>).hasSecondaryCategories ?? null,
          additionalCategories:
            (audit.gbpLookup as Record<string, unknown>).additionalCategories || [],
          hasDescription: (audit.gbpLookup as Record<string, unknown>).hasDescription ?? null,
          description: (audit.gbpLookup as Record<string, unknown>).description || null,
          citationConsistency:
            (audit.gbpLookup as Record<string, unknown>).citationConsistency ?? null,
          directoriesPresent:
            (audit.gbpLookup as Record<string, unknown>).directoriesPresent ?? null,
          industryCitations: (audit.gbpLookup as Record<string, unknown>).industryCitations ?? null,
          brandMentions: (audit.gbpLookup as Record<string, unknown>).brandMentions ?? null,
          citationsEvidence: (audit.gbpLookup as Record<string, unknown>).citationsEvidence || null,
          hasBacklinks: (audit.gbpLookup as Record<string, unknown>).hasBacklinks ?? null,
          backlinksEvidence: (audit.gbpLookup as Record<string, unknown>).backlinksEvidence || null,
          inOrganicLocal: (audit.gbpLookup as Record<string, unknown>).inOrganicLocal ?? null,
          organicEvidence: (audit.gbpLookup as Record<string, unknown>).organicEvidence || null,
          geoGridVisible: (audit.gbpLookup as Record<string, unknown>).geoGridVisible ?? null,
          geoGridEvidence: (audit.gbpLookup as Record<string, unknown>).geoGridEvidence || null,
          duplicateLikely: (audit.gbpLookup as Record<string, unknown>).duplicateLikely ?? null,
          duplicateEvidence: (audit.gbpLookup as Record<string, unknown>).duplicateEvidence || null,
